...
def save_data(): 
    ...
    # 파일이 읽기모드일 경우 다음의 경고창 출력 
    except Exception as ex: 
        tkinter.messagebox.showerror("오류", "파일이 읽기모드 입니다. %s" % ex)
...
# x 버튼을 눌렀을 때 메세지 창으로 한 번 더 경고하기. 
def close():
    if tkinter.messagebox.askokcancel("종료", "정말 이 프로그램을 종료하시겠습니까 ?"):
        # 예를 누르면 창이 종료된다. 
        app.destroy()

# 프로토콜을 사용하여 창 닫을 때 close 함수를 실행하게 한다. 
